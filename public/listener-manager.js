...
async function setInlineGoodImpression(input) {
  const field = input.classList.contains("gift-excluded-toggle") ? "giftExcluded" : "goodImpression";

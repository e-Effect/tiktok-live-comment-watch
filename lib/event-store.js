...
export class EventStore {
  ...
  async listeners({ username = "", search = "", sort = "last_seen", direction = "desc", classification = "all", blocked = "all", attention = "all", giftExperience = "all", commentExperience = "all", limit = 100, offset = 0, fresh = false } = {}) {
    ...
    const attentionFiltered = attention === "yes" || attention === "no";
  ...
  async listenerContributionPage({ username = "", search = "", sort = "contribution", classification = "all", blocked = "all", attention = "all", giftExperience = "all", commentExperience = "all", limit = 100, offset = 0, fresh = false } = {}) {
    let timer;

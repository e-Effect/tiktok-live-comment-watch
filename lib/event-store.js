...
export class EventStore {
  ...
  async listeners({ username = "", search = "", sort = "last_seen", direction = "desc", classification = "all", blocked = "all", giftExperience = "all", commentExperience = "all", limit = 100, offset = 0, fresh = false } = {}) {
    ...
    const fastOrderBy = !username && !experienceFiltered && classificationMode === "all" && blockedMode === "all" ? fastSortColumns[sort] : null;
    if (fastOrderBy) {
  ...
  async listenerContributionPage({ username = "", search = "", sort = "contribution", classification = "all", blocked = "all", giftExperience = "all", commentExperience = "all", limit = 100, offset = 0, fresh = false } = {}) {
    let timer;
